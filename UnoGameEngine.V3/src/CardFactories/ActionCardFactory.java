...
public class ActionCardFactory implements CardFactory {
    ...
    public Card createCard() {
        Action cardAction = actionRegistry.createAction(actionType); // Use the registry to create the action
        return new ActionCard(color, actionType, cardAction); // Pass the ActionType to the ActionCard
    }
}